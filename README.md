...
| Title | Link |
|---|---|
| Episode 1: Core AI Concepts | [Data/Slides/episode_01_concepts.pdf](https://raw.githubusercontent.com/uoy-research/tfds-course-ai/main/Data/Slides/episode_01_concepts.pdf) |
...
- Run cells with the Run button ![Button icon](Data/Images/button_image.png) or `Ctrl+Enter`. We recommend running cell-by-cell.
- To focus the last-running cell open the resources panel ![RAM/Disk Icon](Data/Images/resources_image.png) and click the down arrow on the resources info (RAM/Disk) panel.
